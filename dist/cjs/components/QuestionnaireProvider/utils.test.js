...
var testQuestionnaire = JSON.parse(JSON.stringify(questionnaireTest_json_1.default));
describe('Enriched questionnaire data', function () {
    it('retrieves the right index for repeatable items', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            expect((0, utils_1.getIndexRepeatable)([{ linkId: 'test' }], 'test', 1)).toEqual(0);
            expect((0, utils_1.getIndexRepeatable)([{ linkId: 'test' }, { linkId: 'test' }, { linkId: 'test' }], 'test', 3)).toEqual(2);
            return [2 /*return*/];
        });
    }); });
    it('with empty questionnaire', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            expect((0, utils_1.enrichQuestionnaireData)({})).toEqual({});
            return [2 /*return*/];
        });
    }); });
    it('with test questionnaire', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            expect((0, utils_1.enrichQuestionnaireData)(testQuestionnaire)).toEqual({
