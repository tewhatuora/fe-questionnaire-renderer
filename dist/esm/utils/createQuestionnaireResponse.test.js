...
import transformFormValues from './createQuestionnaireResponse';
import { API_DATE_FORMAT } from './utils';
var questionnaireWithRepeat = __assign({}, testQuestionnaire);
var itemArray = get(questionnaireWithRepeat, 'item.0.item.0.item');
if (itemArray) {
...
it('creates the questionnaire response object', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        expect(transformFormValues(questionnaireWithRepeat, {
            step1: {
                step1_page1: {
