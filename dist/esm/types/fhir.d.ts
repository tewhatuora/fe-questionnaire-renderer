...
export declare enum AgeComparatorKind {
    _lower = "Lower",
...
export declare enum ContributorTypeKind {
    _author = "author",
    _editor = "editor",
    _reviewer = "reviewer",
    _endorser = "endorser"
}
export declare enum CountComparatorKind {
    _lower = "Lower",
    _lowerOrEqual = "LowerOrEqual",
    _greaterOrEqual = "GreaterOrEqual",
    _greater = "Greater"
}
export declare enum DataRequirement_SortDirectionKind {
    _ascending = "ascending",
    _descending = "descending"
}
export declare enum DistanceComparatorKind {
    _lower = "Lower",
    _lowerOrEqual = "LowerOrEqual",
    _greaterOrEqual = "GreaterOrEqual",
    _greater = "Greater"
}
export declare enum DurationComparatorKind {
    _lower = "Lower",
    _lowerOrEqual = "LowerOrEqual",
    _greaterOrEqual = "GreaterOrEqual",
    _greater = "Greater"
...
export declare enum NarrativeStatusKind {
    _generated = "generated",
    _extensions = "extensions",
    _additional = "additional",
    _empty = "empty"
}
export declare enum QuantityComparatorKind {
    _lower = "Lower",
    _lowerOrEqual = "LowerOrEqual",
    _greaterOrEqual = "GreaterOrEqual",
    _greater = "Greater"
}
export declare enum Questionnaire_EnableWhenOperatorKind {
    _exists = "exists",
    _equal = "=",
    _notEqual = "!=",
    _greater = ">",
...
export declare enum Questionnaire_ItemEnableBehaviorKind {
    _all = "all",
    _any = "any"
}
export declare enum Questionnaire_ItemTypeKind {
    _group = "group",
    _display = "display",
    _boolean = "boolean",
    _decimal = "decimal",
...
export declare enum QuestionnaireResponseStatusKind {
...
export declare enum QuestionnaireStatusKind {
    _draft = "draft",
    _active = "active",
    _retired = "retired",
    _unknown = "unknown"
...
export declare enum Timing_RepeatWhenKind {
    _morn = "MORN",
...
export declare enum Timing_RepeatDurationUnitKind {
    _s = "s",
    _min = "min",
    _h = "h",
    _d = "d",
...
export declare enum Timing_RepeatPeriodUnitKind {
    _s = "s",
    _min = "min",
    _h = "h",
    _d = "d",
...
export declare enum TriggerDefinitionTypeKind {
