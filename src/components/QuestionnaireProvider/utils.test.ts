...
const testQuestionnaire = JSON.parse(JSON.stringify(testData))

describe('Enriched questionnaire data', () => {
  it('retrieves the right index for repeatable items', async () => {
    expect(getIndexRepeatable([{ linkId: 'test' }], 'test', 1)).toEqual(0)
    expect(
      getIndexRepeatable(
        [{ linkId: 'test' }, { linkId: 'test' }, { linkId: 'test' }],
        'test',
        3
      )
    ).toEqual(2)
  ...
  it('with empty questionnaire', async () => {
    expect(enrichQuestionnaireData({} as IQuestionnaire)).toEqual({})
  })

  it('with test questionnaire', async () => {
                  ...
                  item: [
                    {
                      ...
                      linkIdWithParent:
                        'step1.step1_page1.step1_page1_input5.0.step1_page1_input5a',
                    ...
                    },
                    {
                      ...
                      linkIdWithParent:
                        'step1.step1_page1.step1_page1_input5.0.step1_page1_input5b',
